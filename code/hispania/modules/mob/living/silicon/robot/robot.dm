...
/mob/living/silicon/robot
	...
	var/speed = -1 //Quiero que dejemos algo en claro, si al balancear algo vas a justificar algo fuerte con simplemente bajarle la velocidad, encuentra una nueva filosofia para tus balances.
